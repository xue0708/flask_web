...
class User(UserMixin, db.Model):
    ...
    maxdx = db.Column(db.Integer)
    maxdy = db.Column(db.Integer)
    maxdz = db.Column(db.Integer)
    maxgx = db.Column(db.Integer)
    maxgy = db.Column(db.Integer)
    maxgz = db.Column(db.Integer)
